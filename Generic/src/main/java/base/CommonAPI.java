...
public class CommonAPI {
    ...
    @BeforeMethod
    public void setUp( boolean useCloudEnv, @Optional("false")String cloudEnvName,
    ...
    public void typeByNameEnter(String locator, String value) {
    ...
    public void typeByLinkTextEnter(String locator, String value) {
